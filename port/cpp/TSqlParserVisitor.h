...
public:
   ...
   */
    ...
    virtual std::any visitGroup_by_clause(TSqlParser::Group_by_clauseContext *context) = 0;

    virtual std::any visitHaving_clause(TSqlParser::Having_clauseContext *context) = 0;

    virtual std::any visitFrom_table_sources(TSqlParser::From_table_sourcesContext *context) = 0;
