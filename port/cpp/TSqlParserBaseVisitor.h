...
public:
  ...
  virtual std::any visitGroup_by_clause(TSqlParser::Group_by_clauseContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitHaving_clause(TSqlParser::Having_clauseContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitFrom_table_sources(TSqlParser::From_table_sourcesContext *ctx) override {
    return visitChildren(ctx);
  }
