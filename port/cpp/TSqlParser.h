...
public:
  ...
  enum {
    ...
    RuleGroup_by_clause = 473, RuleHaving_clause = 474, RuleFrom_table_sources = 475, 
    RuleTop_clause = 476, RuleTop_percent = 477, RuleTop_count = 478, RuleOrder_by_clause = 479, 
    RuleSelect_order_by_clause = 480, RuleFor_clause = 481, RuleXml_common_directives = 482, 
    RuleOrder_by_expression = 483, RuleGrouping_sets_item = 484, RuleGroup_by_item = 485, 
    RuleOption_clause = 486, RuleOption = 487, RuleOptimize_for_arg = 488, 
    RuleSelect_list = 489, RuleUdt_method_arguments = 490, RuleAsterisk = 491, 
    RuleUdt_elem = 492, RuleExpression_elem = 493, RuleSelect_list_elem = 494, 
    RuleTable_sources = 495, RuleNon_ansi_join = 496, RuleTable_source = 497, 
    RuleTable_source_item = 498, RuleOpen_xml = 499, RuleOpen_json = 500, 
    RuleJson_declaration = 501, RuleJson_column_declaration = 502, RuleSchema_declaration = 503, 
    RuleColumn_declaration = 504, RuleChange_table = 505, RuleChange_table_changes = 506, 
    RuleChange_table_version = 507, RuleJoin_part = 508, RuleJoin_on = 509, 
    RuleCross_join = 510, RuleApply_ = 511, RulePivot = 512, RuleUnpivot = 513, 
    RulePivot_clause = 514, RuleUnpivot_clause = 515, RuleFull_column_name_list = 516, 
    RuleRowset_function = 517, RuleBulk_option = 518, RuleDerived_table = 519, 
    RuleFunction_call = 520, RulePartition_function = 521, RuleFreetext_function = 522, 
    RuleFreetext_predicate = 523, RuleJson_key_value = 524, RuleJson_null_clause = 525, 
    RuleBuilt_in_functions = 526, RuleXml_data_type_methods = 527, RuleDateparts_9 = 528, 
    RuleDateparts_12 = 529, RuleDateparts_15 = 530, RuleDateparts_datetrunc = 531, 
    RuleValue_method = 532, RuleValue_call = 533, RuleQuery_method = 534, 
    RuleQuery_call = 535, RuleExist_method = 536, RuleExist_call = 537, 
    RuleModify_method = 538, RuleModify_call = 539, RuleHierarchyid_call = 540, 
    RuleHierarchyid_static_method = 541, RuleNodes_method = 542, RuleSwitch_section = 543, 
    RuleSwitch_search_condition_section = 544, RuleAs_column_alias = 545, 
    RuleAs_table_alias = 546, RuleTable_alias = 547, RuleWith_table_hints = 548, 
    RuleDeprecated_table_hint = 549, RuleSybase_legacy_hints = 550, RuleSybase_legacy_hint = 551, 
    RuleTable_hint = 552, RuleIndex_value = 553, RuleColumn_alias_list = 554, 
    RuleColumn_alias = 555, RuleTable_value_constructor = 556, RuleExpression_list_ = 557, 
    RuleRanking_windowed_function = 558, RuleAggregate_windowed_function = 559, 
    RuleAnalytic_windowed_function = 560, RuleAll_distinct_expression = 561, 
    RuleOver_clause = 562, RuleRow_or_range_clause = 563, RuleWindow_frame_extent = 564, 
    RuleWindow_frame_bound = 565, RuleWindow_frame_preceding = 566, RuleWindow_frame_following = 567, 
    RuleCreate_database_option = 568, RuleDatabase_filestream_option = 569, 
    RuleDatabase_file_spec = 570, RuleFile_group = 571, RuleFile_spec = 572, 
    RuleEntity_name = 573, RuleEntity_name_for_azure_dw = 574, RuleEntity_name_for_parallel_dw = 575, 
    RuleFull_table_name = 576, RuleTable_name = 577, RuleSimple_name = 578, 
    RuleFunc_proc_name_schema = 579, RuleFunc_proc_name_database_schema = 580, 
    RuleFunc_proc_name_server_database_schema = 581, RuleDdl_object = 582, 
    RuleFull_column_name = 583, RuleColumn_name_list_with_order = 584, RuleInsert_column_name_list = 585, 
    RuleInsert_column_id = 586, RuleColumn_name_list = 587, RuleCursor_name = 588, 
    RuleOn_off = 589, RuleClustered = 590, RuleNull_notnull = 591, RuleScalar_function_name = 592, 
    RuleBegin_conversation_timer = 593, RuleBegin_conversation_dialog = 594, 
    RuleContract_name = 595, RuleService_name = 596, RuleEnd_conversation = 597, 
    RuleWaitfor_conversation = 598, RuleGet_conversation = 599, RuleQueue_id = 600, 
    RuleSend_conversation = 601, RuleData_type = 602, RuleConstant = 603, 
    RulePrimitive_constant = 604, RuleKeyword = 605, RuleId_ = 606, RuleSimple_id = 607, 
    RuleId_or_string = 608, RuleComparison_operator = 609, RuleAssignment_operator = 610, 
    RuleFile_size = 611
  };
  ...
  class From_table_sourcesContext;
  ...
  public:
    ...
    With_table_hintsContext *with_table_hints();
    Output_clauseContext *output_clause();
    From_table_sourcesContext *from_table_sources();
    antlr4::tree::TerminalNode *WHERE();
  ...
  class  From_table_sourcesContext : public antlr4::ParserRuleContext {
  public:
    TSqlParser::Table_sourcesContext *from = nullptr;
    From_table_sourcesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *FROM();
    Table_sourcesContext *table_sources();
  ...
  public:
    ...
    TSqlParser::ExpressionContext *format = nullptr;
  ...
  public:
    ...
    TSqlParser::ExpressionContext *property = nullptr;
  ...
  public:
    ...
    TSqlParser::ExpressionContext *id = nullptr;
  ...
  public:
    ...
    TSqlParser::ExpressionContext *input = nullptr;
    TSqlParser::ExpressionContext *replacing = nullptr;
    TSqlParser::ExpressionContext *with = nullptr;
    antlr4::tree::TerminalNode *REPLACE();
    antlr4::tree::TerminalNode *LR_BRACKET();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  public:
    ...
    TSqlParser::ExpressionContext *str = nullptr;
    TSqlParser::ExpressionContext *from = nullptr;
  ...
  public:
    ...
    TSqlParser::ExpressionContext *type = nullptr;
    TSqlParser::ExpressionContext *property = nullptr;
